...
ПараметрыРегистрации.Вставить("Наименование", "Договор поставки"); //имя под которым обработка будет зарегестрирована в справочнике внешних обработок
ПараметрыРегистрации.Вставить("БезопасныйРежим", ЛОЖЬ);
ПараметрыРегистрации.Вставить("Версия", "1.0"); 
ПараметрыРегистрации.Вставить("Информация", "Печатная форма договора поставки"); 
ТаблицаКоманд = ПолучитьТаблицуКоманд();
ДобавитьКоманду(ТаблицаКоманд, "Договор поставки", "ДоговорПоставки", "ВызовСерверногоМетода", Истина, "ПечатьMXL");
...
УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "ДоговорПоставки", "Договор поставки", СформироватьПечатнуюФорму(МассивОбъектов[0], ОбъектыПечати));
...
МакетОбработки = ПолучитьМакет("ДоговорПоставки");
...
//данные организации
СведенияОбОрганизации    = БухгалтерскийУчетПереопределяемый.СведенияОЮрФизЛице(ДоговорСсылка.Организация, ДоговорСсылка.Дата);
ПредставлениеОрганизации = ОбщегоНазначенияБПВызовСервера.ОписаниеОрганизации(СведенияОбОрганизации, "НаименованиеДляПечатныхФорм,");
ОбластьШапка.Параметры.Организация = ПредставлениеОрганизации;
ОбластьШапка.Параметры.ПодписантОрганизация = СклонениеПредставленийОбъектов.ПросклонятьПредставление(ДоговорСсылка.ДолжностьРуководителя.Наименование, 2,ДоговорСсылка);
ОбластьШапка.Параметры.ФИОПодписантаОрганизация = СклонениеПредставленийОбъектов.ПросклонятьФИО(ДоговорСсылка.Руководитель.ФИО, 2, ДоговорСсылка, ДоговорСсылка.Руководитель.Пол);
ОбластьШапка.Параметры.ОснованиеПолномочийОрганизация = ? (ЗначениеЗаполнено(ДоговорСсылка.ЗаРуководителяПоПриказу),
СклонениеПредставленийОбъектов.ПросклонятьПредставление(ДоговорСсылка.ЗаРуководителяПоПриказу, 2,ДоговорСсылка), "Устава"); 
//данные контрагента
СведенияОКонтрагенте = БухгалтерскийУчетПереопределяемый.СведенияОЮрФизЛице(ДоговорСсылка.Владелец, ДоговорСсылка.Дата);
...
ОбластьШапка.Параметры.ПодписантКонтрагент = СклонениеПредставленийОбъектов.ПросклонятьПредставление(ДоговорСсылка.ДолжностьРуководителяКонтрагента, 2,ДоговорСсылка);
ОбластьШапка.Параметры.ФИОПодписантаКонтрагент = СклонениеПредставленийОбъектов.ПросклонятьФИО(ДоговорСсылка.РуководительКонтрагента, 2, ДоговорСсылка, ДоговорСсылка.ПолРуководителяКонтрагента);
ОбластьШапка.Параметры.ОснованиеПолномочийКонтрагент = ? (ЗначениеЗаполнено(ДоговорСсылка.ЗаРуководителяКонтрагентаПоПриказу),
СклонениеПредставленийОбъектов.ПросклонятьПредставление(ДоговорСсылка.ЗаРуководителяКонтрагентаПоПриказу, 2,ДоговорСсылка), "Устава"); 
