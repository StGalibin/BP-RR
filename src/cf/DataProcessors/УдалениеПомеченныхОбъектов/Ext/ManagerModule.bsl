...
Функция СформироватьИнформациюОТипах(ПараметрыВыполнения, Тип) Экспорт
	...
	ИначеЕсли Информация.ПолноеИмя = "СПРАВОЧНИК.ИДЕНТИФИКАТОРЫОБЪЕКТОВРАСШИРЕНИЙ"
		Или Информация.ПолноеИмя = "СПРАВОЧНИК.ПРЕДОПРЕДЕЛЕННЫЕВАРИАНТЫОТЧЕТОВРАСШИРЕНИЙ"
		Или Информация.ПолноеИмя = "СПРАВОЧНИК.КЛЮЧИАНАЛИТИКИУЧЕТАЗАТРАТ"
		Или Информация.ПолноеИмя = "СПРАВОЧНИК.КЛЮЧИАНАЛИТИКИУЧЕТАНДС" Тогда
		Информация.Технический = Истина;
