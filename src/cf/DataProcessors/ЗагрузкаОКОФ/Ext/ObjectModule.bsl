...
Функция ДобавитьКлассификатор(СтрокаXMLИлиФайл, УникальныйИдентификатор, ПервичныйИсточник = "", MIMEТип = "") Экспорт
	...
	Файл = ПроверитьРазархивироватьФайл(СтрокаXMLИлиФайл, ТипЧитателя, УникальныйИдентификатор, ПервичныйИсточник, MIMEТип);
...
Функция ПроверитьРазархивироватьФайл(Файл, ТипЧитателя, УникальныйИдентификатор, ПервичныйИсточник, MIMEТип = "")
