...
Процедура БухОстаткиВалютнаяСуммаПриИзмененииНаСервере(ИдентификаторСтроки)
	...
	ТекущиеДанные.СуммаДолг = РаботаСКурсамиВалют.ПересчитатьВВалюту(ТекущиеДанные.ВалютнаяСуммаДолг, ТекущиеДанные.Валюта,
		ОбщегоНазначенияБПВызовСервераПовтИсп.ПолучитьВалютуРегламентированногоУчета(), ТекущиеДанные.ДокументРасчетов.Дата);
...
Процедура БухОстаткиВалютнаяСуммаПредоплатаПриИзмененииНаСервере(ИдентификаторСтроки)
	...
	ТекущиеДанные.СуммаПредоплата = РаботаСКурсамиВалют.ПересчитатьВВалюту(ТекущиеДанные.ВалютнаяСуммаПредоплата, ТекущиеДанные.Валюта,
		ОбщегоНазначенияБПВызовСервераПовтИсп.ПолучитьВалютуРегламентированногоУчета(), ТекущиеДанные.СчетНаОплату.Дата);
