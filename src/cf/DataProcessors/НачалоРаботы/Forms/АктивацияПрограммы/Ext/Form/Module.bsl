...
Процедура УправлениеФормой(Форма)
	...
	Элементы.СистемаНалогообложенияПатент.Видимость = Форма.ВидОрганизации <> "ЮридическоеЛицо";
	Элементы.СистемаНалогообложенияЕНВД.Видимость = Форма.ВидОрганизации <> "ЮридическоеЛицо";
...
Процедура УстановитьРегистрационныеДанные(АдресХранилища)
	...
	Если ВидОрганизации = "ЮридическоеЛицо" И СистемаНалогообложения = "Патентная"
...
Процедура СоздатьОрганизацию()
	...
	Если ДанныеРегистрации <> Неопределено Тогда
		...
		Налогообложение.Вставить("СистемаНалогообложения",   СистемаНалогообложения);
		Налогообложение.Вставить("ПлательщикЕНВД",           ПлательщикЕНВД);
		Налогообложение.Вставить("ПрименяетсяУСНПатент",     ПрименяетсяУСНПатент);
		Налогообложение.Вставить("ПлательщикТорговогоСбора", ПлательщикТорговогоСбора);
