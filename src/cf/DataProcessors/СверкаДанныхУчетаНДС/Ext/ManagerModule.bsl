...
Функция ПараметрыЗапросаРеестра(ПараметрыЗадания, ПолучательЗапроса, РеквизитыПокупателя, РеквизитыПоставщиков, АдресДляОтвета, ОтправленныеЗапросы)
	...
	Параметры.Вставить("ИННПокупателя"          , РеквизитыПокупателя.ИНН);
	Параметры.Вставить("КПППокупателя"          , РеквизитыПокупателя.КПП);
	Параметры.Вставить("Контрагент"             , ПолучательЗапроса.Контрагент);
	Параметры.Вставить("ИННПоставщика"          , РеквизитыПоставщиков[ПолучательЗапроса.Контрагент].ИНН);
	Параметры.Вставить("КПППоставщика"          , РеквизитыПоставщиков[ПолучательЗапроса.Контрагент].КПП);
	Параметры.Вставить("АдресДляОтвета"         , АдресДляОтвета);
	Параметры.Вставить("ЭлектроннаяПочта"       , ПолучательЗапроса.ЭлектроннаяПочта);
