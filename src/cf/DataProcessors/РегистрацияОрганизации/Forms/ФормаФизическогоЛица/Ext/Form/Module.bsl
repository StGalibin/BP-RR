...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УправлениеКонтактнойИнформацией.ПриСозданииНаСервере(
		ЭтотОбъект, ФизическоеЛицо, "ГруппаКонтактнаяИнформация", , ИсключаемыеВиды, Истина);
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ЗначениеЗаполнено(КонтактнаяИнформацияПолеEMailФизическиеЛица)
		И НЕ ОбщегоНазначенияКлиентСервер.АдресЭлектроннойПочтыСоответствуетТребованиям(КонтактнаяИнформацияПолеEMailФизическиеЛица) Тогда
...
Процедура ПослеИзмененияКонтактнойИнформации(Результат) Экспорт
	...
	// Требуется для работы общих механизмов контактной информации.
...
Процедура ПроверитьЗаполнениеПаспортныхДанных(Отказ)
	...
	ИначеЕсли ПаспортныеДанные.ДатаВыдачи > ТекущаяДатаСеанса() Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения,
			, "ПаспортныеДанные.ДатаВыдачи", , Отказ);
	КонецЕсли;
	...
	ИначеЕсли ФизическоеЛицо.ДатаРождения > ТекущаяДатаСеанса() Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения, , "ФизическоеЛицо.ДатаРождения", , Отказ);
	ИначеЕсли ЗначениеЗаполнено(ПаспортныеДанные.ДатаВыдачи) И 
		ФизическоеЛицо.ДатаРождения > ПаспортныеДанные.ДатаВыдачи Тогда
