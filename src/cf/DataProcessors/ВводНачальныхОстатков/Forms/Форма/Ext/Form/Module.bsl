...
Процедура ЗаполнитьСписокРазделов()
	...
	СтрокаРаздела.КодыИсключений = ",76.03,76.04,76.01.2,76.01.9,76.01.1,76.07.1,76.07.9,76.10,76.27.1,76.37.1,76.37.9,76.21,76.41,76.АВ,76.ВА,76.Н,76.ОТ,76.51,76.52,";
