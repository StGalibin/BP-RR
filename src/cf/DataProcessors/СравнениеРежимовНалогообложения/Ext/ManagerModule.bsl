...
Процедура УдалитьСохраненныеНастройки() Экспорт
	
	ОбщегоНазначения.ХранилищеСистемныхНастроекУдалить("Обработка.СравнениеРежимовНалогообложения.Форма.Форма/ТекущиеДанные",
		Неопределено,
		Неопределено);
		
	ОбщегоНазначения.ХранилищеСистемныхНастроекУдалить("Обработка.СравнениеРежимовНалогообложения.Форма.Форма/регистрация/ТекущиеДанные",
		Неопределено,
		Неопределено);
