...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	БлокироватьЗакрытиеФормы = ЭтоВебКлиент;
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Элементы.ГруппаПроверка.ТекущаяСтраница = Элементы.ГруппаФайлИзменен
		...
		Если НЕ БлокироватьЗакрытиеФормы
			ИЛИ ЗагруженнаяВыпискаПроверена Тогда
...
Процедура ПоказатьРезультатОднократно(Результат, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли Результат = "ФайлИзменен" Тогда
		Элементы.ГруппаФайл.Видимость = НЕ БлокироватьЗакрытиеФормы;
		Элементы.ГруппаЗагруженнаяВыпискаПроверенаФайлИзменен.Видимость = БлокироватьЗакрытиеФормы;
	ИначеЕсли Результат = "ФайлУдален" Тогда
		Элементы.ГруппаЗагруженнаяВыпискаФайлУдален.Видимость = БлокироватьЗакрытиеФормы;
	КонецЕсли;
...
Процедура ПроверитьФайлНаКлиентеПослеЧтенияФайла(ПомещенныеФайлы, ДополнительныеПараметры) Экспорт
	...
	Если ПомещенныеФайлы <> Неопределено И ПомещенныеФайлы.Количество() > 0 Тогда
		...
		Если Результат = "ФайлИзменен"
			И НЕ БлокироватьЗакрытиеФормы Тогда
