...
Процедура ПрочитатьНастройкиПользователя()
	...
	Настр_ПроводитьПриЗагрузкеСписаниеСРасчетногоСчета   = Настройки.СозданиеДокументов[Тип("ДокументСсылка.СписаниеСРасчетногоСчета")].ПроводитьДокумент;
	Настр_ПроводитьПриЗагрузкеПоступлениеНаРасчетныйСчет = Настройки.СозданиеДокументов[Тип("ДокументСсылка.ПоступлениеНаРасчетныйСчет")].ПроводитьДокумент;
...
Процедура ЗаписатьНастройки()
	...
	НастройкиЗагрузки.СозданиеДокументов[Тип("ДокументСсылка.СписаниеСРасчетногоСчета")].ПроводитьДокумент   = Настр_ПроводитьПриЗагрузкеСписаниеСРасчетногоСчета;
	НастройкиЗагрузки.СозданиеДокументов[Тип("ДокументСсылка.ПоступлениеНаРасчетныйСчет")].ПроводитьДокумент = Настр_ПроводитьПриЗагрузкеПоступлениеНаРасчетныйСчет;
