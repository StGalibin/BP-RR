...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокОбъектов.Добавить(Метаданные.Документы.ПриходныйКассовыйОрдер);
	УправлениеПечатью.ПриСозданииНаСервере(ЭтотОбъект, Элементы.СписокГруппаПечатьПКО, СписокОбъектов);
	УправлениеПечатью.ПриСозданииНаСервере(ЭтотОбъект, Элементы.ПеренумерованныеГруппаПечатьПКО, СписокОбъектов);
	
	СписокОбъектов = Новый Массив();
	СписокОбъектов.Добавить(Метаданные.Документы.РасходныйКассовыйОрдер);
	УправлениеПечатью.ПриСозданииНаСервере(ЭтотОбъект, Элементы.СписокГруппаПечатьРКО, СписокОбъектов);
	УправлениеПечатью.ПриСозданииНаСервере(ЭтотОбъект, Элементы.ПеренумерованныеГруппаПечатьРКО, СписокОбъектов);
	
	СписокОбъектов = Новый Массив();
	СписокОбъектов.Добавить(Метаданные.Документы.СчетФактураВыданный);
	УправлениеПечатью.ПриСозданииНаСервере(ЭтотОбъект, Элементы.СписокГруппаПечатьСФ, СписокОбъектов);
	УправлениеПечатью.ПриСозданииНаСервере(ЭтотОбъект, Элементы.ПеренумерованныеГруппаПечатьСФ, СписокОбъектов);
	...
	Элементы.СписокГруппаПечатьСФ.Видимость = ЭтоПеренумерацияСФ;
	...
	Элементы.ПеренумерованныеГруппаПечатьСФ.Видимость = ЭтоПеренумерацияСФ;
