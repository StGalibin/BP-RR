...
Процедура УстановитьВидимостьГрупп()
	...
	УчетПоПодразделениям = ПолучитьФункциональнуюОпцию("ВестиУчетПоПодразделениям");
	РасчетЗарплатыПоПодразделениям = ПолучитьФункциональнуюОпцию("РасчетЗарплатыПоПодразделениямДляНебольшихОрганизаций");
...
Процедура ЗаполнитьСведенияОНалоговойИнспекцииПоКоду(ОписаниеОшибки = "")
	...
	КодРегионаРегистрации                        = Лев(КодНалоговогоОргана, 2);
	РегистрацияВНалоговомОргане.КодРегиона 		 = Лев(КодНалоговогоОргана, 2);
