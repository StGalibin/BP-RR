...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВыбранныеФорматыСохранения.Добавить("RTF", "Текст в формате RTF (.rtf)",
		Истина, БиблиотекаКартинок.ФорматWord);
	ВыбранныеФорматыСохранения.Добавить(ТипФайлаТабличногоДокумента.HTML,
