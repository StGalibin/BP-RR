...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИспользоватьСнятыеСПоддрежкиДрайвера = МенеджерОборудованияВызовСервераПереопределяемый.ВозможностьИспользоватьСнятыхСПоддрежкиДрайверов();
...
Функция ПолучитьСписокДрайверов(ТипОборудования, ТолькоДоступные)
	...
	Если НЕ ИспользоватьСнятыеСПоддрежкиДрайвера Тогда
