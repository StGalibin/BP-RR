...
//Заполняет наименования проверок при обновлении
//
Процедура ЗаполнитьНаименованияПроверок() Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
		...
		|	И НЕ ПроверкиКонтролирующимиОрганами.ПометкаУдаления";
	...
	Пока ВыборкаЭлементов.Следующий() Цикл
		...
		ЭлементОбъект = ВыборкаЭлементов.Ссылка.ПолучитьОбъект();
		ЭлементОбъект.Наименование = КраткоеНаименованиеПроверки(ЭлементОбъект.КонтролирующийОрган, НаименованияОргановИСлова);
