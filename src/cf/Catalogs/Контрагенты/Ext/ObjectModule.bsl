...
Процедура ОбработкаЗаполненияПоСтруктуре(ДанныеЗаполнения)
	...
	Если ДанныеЗаполнения.Свойство("ЮридическийАдрес") Тогда
		...
		УправлениеКонтактнойИнформациейБП.ЗаполнитьКонтактнуюИнформациюОбъекта(ЭтотОбъект,
				Справочники.ВидыКонтактнойИнформации.ЮрАдресКонтрагента, ДанныеЗаполнения.ЮридическийАдрес);
		
		Если Не ДанныеЗаполнения.Свойство("ФактическийАдрес") Тогда
			УправлениеКонтактнойИнформациейБП.ЗаполнитьКонтактнуюИнформациюОбъекта(ЭтотОбъект,
					Справочники.ВидыКонтактнойИнформации.ФактАдресКонтрагента, ДанныеЗаполнения.ЮридическийАдрес);
		КонецЕсли;
		
		Если Не ДанныеЗаполнения.Свойство("ПочтовыйАдрес") Тогда
			УправлениеКонтактнойИнформациейБП.ЗаполнитьКонтактнуюИнформациюОбъекта(ЭтотОбъект,
					Справочники.ВидыКонтактнойИнформации.ПочтовыйАдресКонтрагента, ДанныеЗаполнения.ЮридическийАдрес);
		КонецЕсли;
	...
	Если ДанныеЗаполнения.Свойство("Телефон") Тогда
		УправлениеКонтактнойИнформациейБП.ЗаполнитьКонтактнуюИнформациюОбъекта(ЭтотОбъект,
				Справочники.ВидыКонтактнойИнформации.ТелефонКонтрагента, ДанныеЗаполнения.Телефон);
	КонецЕсли;
