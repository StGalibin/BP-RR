...
Процедура РазместитьКонтактнуюИнформацию()
	...
	УправлениеКонтактнойИнформацией.ПриСозданииНаСервере(ЭтотОбъект, Объект, "ГруппаКомпоновкиКонтактнойИнформации", ПоложениеЗаголовкаЭлементаФормы.Лево, ИсключаемыеВиды);
	// Конец СтандартныеПодсистемы.КонтактнаяИнформация
