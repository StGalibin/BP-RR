...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЕстьПравоДоступаКБухфону Тогда
		...
		Элементы.ОнлайнПоддержка.Видимость = НастройкиПользователя.ВидимостьКнопки1СБухфон;
	Иначе
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	// СтандартныеПодсистемы.Интеграция1СБухфон
	Если ЕстьПравоДоступаКБухфону Тогда
		ТехнологияСервисаИнтеграцияСБСПКлиент.Интеграция1СБухфонКлиентОбработкаОповещения(ИмяСобытия, Элементы.ОнлайнПоддержка);
	КонецЕсли;
	// Конец СтандартныеПодсистемы.Интеграция1СБухфон
