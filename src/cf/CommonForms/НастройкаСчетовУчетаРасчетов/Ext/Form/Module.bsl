...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ТаблицаСчетовРасчета.Подсказка = ПодсказкаТаблицыСчетовРасчета(Тип, ВызовИзОбработкиПланирования);
...
Функция ПодсказкаТаблицыСчетовРасчета(Тип, ВызовИзОбработкиПланирования)
	...
	Если ВызовИзОбработкиПланирования Тогда
		...
		Если Тип = 1 Тогда
			ТекстПодсказки =
			НСтр("ru = 'Выбранные счета учитываются при подсчете задолженностей по договорам с видом:
			|""С покупателем"", ""С комиссионером (агентом) на продажу"", 
			|""С комитентом (принципалом) на закупку"".'");
		ИначеЕсли Тип = 2 Тогда
			ТекстПодсказки =
			НСтр("ru = 'Выбранные счета учитываются при подсчете задолженностей по договорам с видом:
			|""С поставщиком"", ""С комитентом (принципалом) на продажу"", 
	...
	Иначе
		...
		Если Тип = 1 Тогда
			...
			|При расчете анализируется остаток по дебету по договорам с видом 
			|""С покупателем"", ""С комиссионером (агентом) на продажу"" и 
			|""С комитентом (принципалом) на закупку"".'");
		ИначеЕсли Тип = 2 Тогда
			ТекстПодсказки =
			НСтр("ru = 'В таблице приведены счета учета расчетов, по которым формируется отчет.
			|При расчете анализируется остаток по кредиту по договорам с видом 
