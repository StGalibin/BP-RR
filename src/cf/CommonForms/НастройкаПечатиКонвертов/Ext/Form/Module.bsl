...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.Организация.Видимость = Не (ВОбъектеПечатиЕстьОрганизация Или ИспользуетсяОднаОрганизация);
...
Процедура КомандаПродолжить(Команда)
	...
	ОценкаПроизводительностиКлиентСервер.НачатьЗамерВремени("ПечатьКонвертов");
