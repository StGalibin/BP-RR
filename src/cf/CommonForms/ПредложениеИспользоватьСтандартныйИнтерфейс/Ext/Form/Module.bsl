...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ДекорацияВключитьСтандартныйИнтерфейс82.Видимость = ВключитьСтандартныйИнтерфейс И Интерфейс82;
	Элементы.ДекорацияИзменитьКомандныйИнтерфейс77.Видимость = ИзменитьКомандныйИнтерфейс И Интерфейс77;
	Элементы.ДекорацияИзменитьКомандныйИнтерфейс82.Видимость = ИзменитьКомандныйИнтерфейс И Интерфейс82;
