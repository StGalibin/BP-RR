...
Процедура УстановитьВидимостьНаСервере()
	...
	Если ПравилаОтправкиСправочников = "НеСинхронизировать"
		...
		Элементы.ГруппаОтправлятьВидыЦенНоменклатурыФлагИКоманда.Видимость = Ложь;
		
	Иначе
		
		Элементы.ГруппаОтправлятьВидыЦенНоменклатурыФлагИКоманда.Видимость = Истина;
		
		Элементы.ОткрытьСписокОтправляемыхВидовЦенНоменклатуры.Видимость = ВыгружатьЦеныНоменклатуры И СтруктураФункциональныхОпций.ИспользоватьНесколькоВидовЦен;
		
	КонецЕсли;
	
	Элементы.ГруппаПравилаСозданияДоговоровКонтрагентов.Видимость =  ПравилаОтправкиДокументов <> "НеСинхронизировать";
	...
	ИспользоватьОбобщенныеСклады = (ПравилаОтправкиДокументов <> "НеСинхронизировать") И СтруктураФункциональныхОпций.ИспользоватьНесколькоСкладов;
	Элементы.СтраницыВариантовОтображенияОбощенногоСклада.Видимость = ИспользоватьОбобщенныеСклады;
	
	Если ИспользоватьОбобщенныеСклады Тогда
	...
	Элементы.СписокВыбораПринципаОбособленныхПодразделений.Видимость = ПравилаОтправкиСправочников <> "НеСинхронизировать";
