...
//                            и в который будет помещена ВТ "ВТИзменившиесяАдресаФизическихЛиц".
...
Функция ПолучитьДанныеДокументаВФорматеПФР(ДокументВид, ДокументСерия, ДокументНомер, ДокументДатаВыдачи, ДокументКемВыдан, ДокументКодПФР, ДокументНаименование) Экспорт 
	...
	ДанныеДокумента.НаименованиеУдостоверяющегоДокумента = ?(СокрЛП(ДокументКодПФР) = "ПРОЧЕЕ", ВРег(СокрЛП(ДокументНаименование)), СокрЛП(ДокументКодПФР));;
...
Функция ПечатнаяФормаОДВ_1(МассивОбъектов, ОбъектыПечати, ИмяДокумента) Экспорт 
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("ОбщийМакет.ПФ_MXL_ФормаОДВ_1");
...
Процедура ВывестиОбластьОДВ_1(ВыводимаяОбласть, ДокументРезультат, ТекущийЛист)
	...
	Если ОбщегоНазначения.ПроверитьВыводТабличногоДокумента(ТекущийЛист, ВыводимыеОбласти, Ложь) Тогда 
