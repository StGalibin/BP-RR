...
Функция СообщитьОбОшибкеЗаполненияРеквизитовДляОтчетности(Организация, НезаполненныеРеквизиты, ИмяЭлементаФормы, Отказ, ТекстОписанияОбъектаПроверки = Неопределено) Экспорт
	...
	Если ТипЗнч(НезаполненныеРеквизиты) = Тип("Массив") И НезаполненныеРеквизиты.Количество() <= 3 Тогда
