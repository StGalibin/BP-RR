...
Процедура СоздатьНовоеПисьмоПроверкаУчетнойЗаписиВыполнена(УчетнаяЗаписьНастроена, ПараметрыОтправки) Экспорт
	Перем Отправитель, Получатель, АдресПолучателяСкрытойКопии, Вложения, Тема, Текст, УдалятьФайлыПослеОтправки;
	...
	ПараметрыОтправки.Свойство("АдресПолучателяСкрытойКопии", АдресПолучателяСкрытойКопии);
	...
	Иначе
		ОткрытьПростуюФормуОтправкиПочтовогоСообщения(Отправитель, Получатель, АдресПолучателяСкрытойКопии,
...
Процедура ОткрытьПростуюФормуОтправкиПочтовогоСообщения(Отправитель,
			Получатель, АдресПолучателяСкрытойКопии, Тема,Текст, СписокФайлов, УдалятьФайлыПослеОтправки, ОписаниеОповещенияОЗакрытии)
...
Процедура ОтправитьТабличныеДокументыСохранениеВыполнено(СохраненныеДокументы, Контекст) Экспорт
	...
	ДопПараметры = Новый Структура("Вложения", ПараметрыОтправки.Вложения);
