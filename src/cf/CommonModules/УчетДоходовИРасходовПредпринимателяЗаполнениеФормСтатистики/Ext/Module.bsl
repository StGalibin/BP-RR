...
Функция ВыручкаИППоВидамДейтельности(Организация, НачалоПериода, КонецПериода) Экспорт
	...
	РеквизитыОрганизации = "ЮридическоеФизическоеЛицо, КодОКВЭД, НаименованиеОКВЭД";
	РеквизитыОрганизации = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Организация, РеквизитыОрганизации);
	
	НаименованиеОсновногоВидаДеятельности = РеквизитыОрганизации.НаименованиеОКВЭД;
	ОКВЭДОсновногоВидаДеятельности = РеквизитыОрганизации.КодОКВЭД;
		...
		Если УчетнаяПолитика.ВестиУчетПоВидамДеятельностиИП(Организация, КонецПериода) Тогда
			...
			Пока ВыборкаВидов.Следующий() Цикл 
				...
				Если ВыборкаОбщие.Следующий() Тогда
					...
					ВыручкаПоВидуДеятельности.Выручка	= ВыборкаОбщие.Доходы + ВыборкаОбщие.ПрочиеДоходы;
			...
			Если ВыборкаОбщие.Следующий() Тогда
				ВыручкаПоВидуДеятельности			= ВыручкаПоВидамДеятельности.Добавить();
				ВыручкаПоВидуДеятельности.Выручка	= ВыборкаОбщие.Доходы + ВыборкаОбщие.ПрочиеДоходы - ВыручкаПоВидамДеятельности.Итог("Выручка");
	...
	// Выручка Патент
	ПатентыИП = Справочники.Патенты.ПолучитьПатентыОрганизации(Организация, КонецПериода);
