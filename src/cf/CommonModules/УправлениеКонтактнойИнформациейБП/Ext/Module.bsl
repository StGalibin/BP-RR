...
Функция НаселенныйПунктПоАдресу(ЗначенияПолей) Экспорт
	...
	СтруктураПолейАдреса = УправлениеКонтактнойИнформацией.СведенияОбАдресе(ЗначенияПолей, ДополнительныеПараметры);
...
Функция СравнитьАдреса(Адрес1, Адрес2) Экспорт
	...
	ДополнительныеПараметры =  Новый Структура("НаименованиеВключаетСокращение", Ложь);
	СведенияОбАдресе1 = УправлениеКонтактнойИнформацией.СведенияОбАдресе(Адрес1, ДополнительныеПараметры);
	СведенияОбАдресе2 = УправлениеКонтактнойИнформацией.СведенияОбАдресе(Адрес2, ДополнительныеПараметры);
...
Функция СтруктураАдреса(АдресЗначенияПолей, ДополнительныеПараметры = Неопределено) Экспорт
	...
	СведенияОбАдресе = УправлениеКонтактнойИнформацией.СведенияОбАдресе(АдресЗначенияПолей, ДополнительныеПараметры);
...
Функция СравнитьНаселенныеПункты(Адрес1, Адрес2) Экспорт
	...
	ЗаполнитьЗначенияСвойств(НаселенныйПункт1, УправлениеКонтактнойИнформацией.СведенияОбАдресе(Адрес1, ДополнительныеПараметры));
	ЗаполнитьЗначенияСвойств(НаселенныйПункт2, УправлениеКонтактнойИнформацией.СведенияОбАдресе(Адрес2, ДополнительныеПараметры));
