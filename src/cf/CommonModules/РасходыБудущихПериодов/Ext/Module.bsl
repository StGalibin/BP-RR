...
Функция СуммыРасходовОчередногоМесяца(Остаток, ОписаниеСумм, СпособПризнанияРасходов, ОчереднойМесяц, НачалоПериода, КонецПериода, ПротоколРасчета = Неопределено) Экспорт
	...
	НалогНаПрибыльБухгалтерскийУчет.ИсправитьПогрешностиОкругления(СуммыРасходов, Остаток, ОписаниеСумм, Доля, 1);
