...
Функция СвойстваСтрокРасшифровкиПлатежаСервер(Знач ПараметрыПлатежа, Знач ПолучатьДоговор) Экспорт
	 ...
	 Возврат РасходныйКассовыйОрдерФормы.СвойстваСтрокРасшифровкиПлатежаСервер(ПараметрыПлатежа, ПолучатьДоговор);
...
Функция ПодготовитьДанныеДляПробитияЧека(Знач Ссылка,Знач НомерСекции,Знач ВерсияФормата,СообщениеОшибке) Экспорт
	
	Возврат Документы.РасходныйКассовыйОрдер.СобратьДанныеЧеков(Ссылка, НомерСекции, ВерсияФормата, СообщениеОшибке);
