...
Процедура ВыполнитьДействие(ОписаниеДействия) Экспорт
	...
	ИначеЕсли ОписаниеДействия.Свойство("МастерПодключенияК1СОтчетности") Тогда
		
		ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиент.ОткрытьФормуМастераЗаявленияНаПодключение(ОписаниеДействия.Организация);
		ЗарегистрироватьВЖурналеОткрытиеФормы("МастерПодключенияК1СОтчетности");
