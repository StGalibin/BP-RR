...
Функция ИнформацияПоПоказателюДоходы(Организация, ДатаПроверки)
	...
	Запрос.УстановитьПараметр("НачалоПериода", НачалоГода(ДатаПроверки));
...
Функция ИнформацияПоПоказателюРаботники(Организация, ДатаПроверки)
	...
	СведенияОЧисленностиРаботников = КадровыйУчет.СреднесписочнаяЧисленностьРаботающих(Организация, НачалоГода(ДатаПроверки), ДатаПроверки);
