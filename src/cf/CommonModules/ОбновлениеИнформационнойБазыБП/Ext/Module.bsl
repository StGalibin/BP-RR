...
#КонецОбласти
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.51.22";
	Обработчик.Процедура           = "Документы.СчетФактураВыданный.СброситьИспользованиеПользовательскогоМакетаСчетаФактуры";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.51.22";
	Обработчик.Процедура           = "Обработки.ПечатьУПД.СброситьИспользованиеПользовательскогоМакетаУПД";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.51.22";
	Обработчик.Процедура           = "Обработки.ПечатьУКД.СброситьИспользованиеПользовательскогоМакетаУКД";
	Обработчик.НачальноеЗаполнение = Ложь;
...
Процедура УстановитьДатуТекущейВерсии() Экспорт
	...
	Константы.ДатаТекущейВерсии.Установить(Дата(2017,07,18));
