...
Функция НовыйПеременныйНаборСумм()
	...
	КоллекцияСумм.Колонки.Добавить("Сумма",  БухгалтерскийУчетКлиентСервер.ТипСумма());
...
Функция ДоляСуммы(Знач Сумма, Знач Числитель, Знач Знаменатель) Экспорт
	...
	Возврат Окр(Цена * Числитель, БухгалтерскийУчетКлиентСервер.РазрядностьДробнойЧастиСумм());
