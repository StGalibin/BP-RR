...
Процедура РасшифровкаПлатежаПолеОтражениеАвансаОбработкаВыбора(Форма, Элемент, ВыбранноеЗначение, СтандартнаяОбработка) Экспорт
	...
	Если ВыбранныйЭлемент <> Неопределено Тогда
		СтрокаПлатеж.ПорядокОтраженияАванса = Форма.ПорядокОтраженияАвансаСоответствиеЗначений[СписокВыбора.Индекс(ВыбранныйЭлемент)];
		ПоступлениеНаРасчетныйСчетФормыКлиентСервер.ЗаполнитьРеквизитыРасшифровкаПлатежа(Форма, Истина, СтрокаПлатеж);
	КонецЕсли;
...
&НаКлиенте
Процедура РасшифровкаПлатежаОбработкаВыбора(Форма, Элемент, ВыбранноеЗначение) Экспорт
	...
	Если Форма.ПрименяетсяУСНПатент Тогда
		...
		УчетПСНКлиент.ОбработатьВыборНовогоПатентаИзКоллекции(СписокВыбора, Элемент.ТекущиеДанные.ПолеОтражениеАванса, ВыбранноеЗначение,
			Форма.ПорядокОтраженияАвансаСоответствиеЗначений);
		Элемент.ТекущиеДанные.ПорядокОтраженияАванса = ВыбранноеЗначение;
	КонецЕсли;
...
Процедура ИнкассацияСтатьяДвиженияДенежныхСредствПриИзменении(Форма, Элемент) Экспорт
	...
	СтрокаПлатеж = ПоступлениеНаРасчетныйСчетФормыКлиентСервер.РасшифровкаПлатежаТекущиеДанные(Форма, "РасшифровкаПлатежаИнкассация");
...
Процедура РасшифровкаПлатежаПлатежныеКартыПриОкончанииРедактирования(Форма, Элемент, НоваяСтрока, ОтменаРедактирования) Экспорт
	...
	Если НоваяСтрока И ОтменаРедактирования Тогда
		...
		Объект.СуммаДокумента = РасшифровкаПлатежа.Итог("СуммаПлатежа");
		ПлатежныеКартыОбработатьИзменениеСуммыУслуг(Форма);
	КонецЕсли;
...
Процедура РасшифровкаПлатежаПлатежныеКартыСуммаПлатежаПриИзменении(Форма, Элемент) Экспорт
...
Процедура ПлатежныеКартыСуммаУслугПриИзменении(Форма, Элемент, ЕстьТабличнаяЧасть = Истина) Экспорт
	...
	ПлатежныеКартыОбработатьИзменениеСуммыУслуг(Форма, ЕстьТабличнаяЧасть);
...
Процедура ПлатежныеКартыОбработатьИзменениеСуммыУслуг(Форма, ЕстьТабличнаяЧасть = Истина)
