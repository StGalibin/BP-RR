...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик                     = Обработчики.Добавить();
	Обработчик.Версия              = "1.0.10.29";
	Обработчик.МонопольныйРежим    = Ложь;
	Обработчик.ОбщиеДанные         = Истина;
	Обработчик.РежимВыполнения     = "Оперативно";
	Обработчик.Процедура           = "ТарификацияСлужебный.УстановитьЗначениеПоУмолчаниюВремяЖизниКэшаЛицензийУникальныхУслуг";
	Обработчик.НачальноеЗаполнение = Истина;
...
Процедура ПриЗаполненииТиповИсключаемыхИзВыгрузкиЗагрузки(Типы) Экспорт
	...
	Типы.Добавить(Метаданные.РегистрыСведений.КэшЛицензийУникальныхУслуг);
	...
	Типы.Добавить(Метаданные.Константы.ВремяЖизниКэшаЛицензийУникальныхУслугСервиса);
...
// Утснавливает значение по умолчанию (1 день) константе "ВремяЖизниКэшаЛицензийУникальныхУслуг".
//
Процедура УстановитьЗначениеПоУмолчаниюВремяЖизниКэшаЛицензийУникальныхУслуг() Экспорт
	
	УстановитьПривилегированныйРежим(Истина);
	Константы.ВремяЖизниКэшаЛицензийУникальныхУслугСервиса.Установить(1440);
...
// Возвращает время кэша лицензий уникальных услуг в секундах.
//
// Возвращаемое значение:
//  Число - количество секунд.
//
Функция ВремяЖизниКэшаЛицензийУникальныхУслугВСекундах() Экспорт
	
	Возврат Константы.ВремяЖизниКэшаЛицензийУникальныхУслугСервиса.Получить() * 60;
...
// Возвращает поддерживает ли Менеджер сервиса управление тарифами в приложениях версии 1.0.1.1.
//
// Возвращаемое значение:
//  Булево - Истина, если поддерживает, Ложь - иначе.
//
