...
Функция ИдентификаторПриложения()
	...
	Если ИмяКонфигурации = "БухгалтерияПредприятияБазовая"
		И ОбщегоНазначенияПовтИсп.РазделениеВключено() Тогда
		ИдентификаторПриложения.client_id     = "404983699965-uk79iejchoq0s3nvs739sf2nt7du7i7p.apps.googleusercontent.com";
		ИдентификаторПриложения.client_secret = "DYLh-6nAzHnz6ez_6DEwm0h6";
	...
	ИначеЕсли ИмяКонфигурации = "БухгалтерияПредприятияБазовая1" Тогда
		ИдентификаторПриложения.client_id     = "975238508191-rh4gjfek32r2dbpk0sv0shtuhr32rrgm.apps.googleusercontent.com";
		ИдентификаторПриложения.client_secret = "jNzwE9z81fZuJWazpDJGy0-2";
		ИдентификаторПриложения.auth_uri      = "https://accounts.google.com/o/oauth2/auth";
		ИдентификаторПриложения.token_uri     = "https://accounts.google.com/o/oauth2/token";
		ИдентификаторПриложения.redirect_uri  = "urn:ietf:wg:oauth:2.0:oob";
	Иначе
...
Функция НовыйИдентификаторПриложения()
	...
	ИдентификаторПриложения.Вставить("ОбластьДоступа", "https://www.googleapis.com/auth/calendar");
