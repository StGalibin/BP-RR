...
Функция СчетПозволяетИдентифицироватьКонтрагента(БалансовыйСчет) Экспорт
	...
	Если БалансовыйСчет = "40101" 
		...
		Или БалансовыйСчет = "40312" Тогда
		Возврат Ложь;
	КонецЕсли;
...
Функция ЭтоБанковскийОрдер(ШифрОперации) Экспорт
	...
	Возврат ШифрОперации = 17; // 17 - Списано, зачислено по банковскому ордеру
	
КонецФункции

Функция ЭтоМемориальныйОрдер(ШифрОперации) Экспорт
	
	Возврат ШифрОперации = 9;   // 09 - Списано, зачислено по мемориальному ордеру
...
// Проверяет, применяет ли страна формат IBAN, по данным IBAN REGISTRY Release 59 – August 2015
...
Функция СтранаПрименяетФорматIBAN(КодСтраны) Экспорт
	...
	КодыВсехСтранПрименяющихIBAN = "/AL/AD/AT/AZ/BH/BE/BA/BR/BG/CR/HR/CY/CZ/DK/FO/GL/DO/EE/FI/FR/GE" + 
		"/DE/GI/GR/GT/HU/IS/IE/IL/IT/JO/KZ/XK/KW/LV/LB/LI/LT/LU/MK/MT/MR/MU/MD/MC/ME/NL/NO/PK/PS/PL" +
		"/PT/RO/QA/LC/SM/SA/RS/SK/SI/ES/SE/CH/TL/TN/TR/AE/GB/VG/";
