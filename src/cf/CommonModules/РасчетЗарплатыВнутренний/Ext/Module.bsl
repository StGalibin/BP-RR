...
Процедура ЗаполнитьДатыВыплатыВНачисленияхЗарплаты(ПараметрыОбновления) Экспорт
	...
	РасчетЗарплатыБазовый.ЗаполнитьДатыВыплатыВНачисленияхЗарплаты(ПараметрыОбновления);
...
Процедура ЗаполнитьИдентификаторыСтрокВРегистрахНакопления(ПараметрыОбновления) Экспорт
	...
	РасчетЗарплатыБазовый.ЗаполнитьИдентификаторыСтрокВРегистрахНакопления(ПараметрыОбновления);
	
КонецПроцедуры

Процедура ЗаполнитьГоловныеОрганизацииПлановыхАвансов(ПараметрыОбновления) Экспорт
	
	РасчетЗарплатыБазовый.ЗаполнитьГоловныеОрганизацииПлановыхАвансов(ПараметрыОбновления);
