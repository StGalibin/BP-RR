...
Процедура ПереопределитьСписокЛентНовостейДляКонтекстныхНовостей(СписокЛентНовостей = Неопределено) Экспорт
	...
	СписокЛентНовостей = ИнтернетПоддержкаПользователейБППовтИсп.ПолучитьСписокЛентНовостейДляКонтекстныхНовостей();
