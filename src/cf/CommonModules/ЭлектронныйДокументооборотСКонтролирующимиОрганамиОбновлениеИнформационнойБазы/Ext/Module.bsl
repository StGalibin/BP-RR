...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "1.1.10.7";
	Обработчик.Процедура           = "ЭлектронныйДокументооборотСКонтролирующимиОрганамиОбновлениеИнформационнойБазы.УдалитьУстаревшийОтложенныйОбработчик";
	Обработчик.НачальноеЗаполнение = Ложь;
...
Процедура УдалитьУстаревшийОтложенныйОбработчик() Экспорт
	
	ОбновлениеИнформационнойБазы.УдалитьОтложенныйОбработчикИзОчереди(
		"ЭлектронныйДокументооборотСКонтролирующимиОрганамиОбновлениеИнформационнойБазы.СкопироватьСертификатыВХранилищеСертификатовБТС");
