...
Функция ОСВ_ПоКонтрагентамДоговорам(ПараметрыОСВ) Экспорт
	...
	ТекстЗапроса = "ВЫБРАТЬ
	               ...
	               |	ВЫРАЗИТЬ(ХозрасчетныйОстаткиИОбороты.Субконто1 КАК Справочник.Контрагенты).ИНН КАК КонтрагентИНН,
	               |	ВЫРАЗИТЬ(ХозрасчетныйОстаткиИОбороты.Субконто1 КАК Справочник.Контрагенты).КПП КАК КонтрагентКПП,
	               |	ВЫРАЗИТЬ(ХозрасчетныйОстаткиИОбороты.Субконто2 КАК Справочник.ДоговорыКонтрагентов).Наименование КАК ДоговорПредставление,
	               |	ВЫРАЗИТЬ(ХозрасчетныйОстаткиИОбороты.Субконто2 КАК Справочник.ДоговорыКонтрагентов).Номер КАК ДоговорНомер,
	               |	ВЫРАЗИТЬ(ХозрасчетныйОстаткиИОбороты.Субконто2 КАК Справочник.ДоговорыКонтрагентов).Дата КАК ДоговорДата,
	               |	ВЫРАЗИТЬ(ХозрасчетныйОстаткиИОбороты.Субконто2 КАК Справочник.ДоговорыКонтрагентов).СрокДействия КАК ДоговорСрокДействия,
	               |	ХозрасчетныйОстаткиИОбороты.СуммаНачальныйОстатокДт КАК СНД,
...
Функция ОСВ_ПоКредитамЗаймам(ПараметрыОСВ) Экспорт
...
Функция АнализБезСубконтоПоМесяцам(ПараметрыАнализа) Экспорт
...
Функция АнализПоБанковскимСчетам(ПараметрыАнализа) Экспорт
