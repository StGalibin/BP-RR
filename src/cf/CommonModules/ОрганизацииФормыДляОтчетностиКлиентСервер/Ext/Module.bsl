...
// 
Процедура ИзменениеКодаОКВЭД2(Форма) Экспорт
...
//
Функция АдресОрганизацииЗначенияПолей(КонтактнаяИнформацияОписаниеДополнительныхРеквизитов) Экспорт
...
Функция НовыйОтветДанныхЕГР(Запрос) Экспорт
	...
	Ответ.Вставить("АдресДанных",   ""); // Данные по этому адресу - ДанныеЕдиныхГосРеестров.НовыеРеквизитыЮридическогоЛица
	                                     // или ДанныеЕдиныхГосРеестров.НовыеРеквизитыПредпринимателя
