...
Процедура ПоказатьСообщениеОбИсправленииКодаПериодаДекларации2016() Экспорт
	
	ОткрытьФорму("Обработка.ИсправлениеКодаПериодаДекларацииНалогНаПрибыль2016.Форма.ЗаглавнаяФорма");
