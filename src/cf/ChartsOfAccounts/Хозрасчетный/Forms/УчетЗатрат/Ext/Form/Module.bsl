...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ВестиУчетЗатратПоПодразделениямПоКаждомуПодразделению.Доступность 	= НЕ ВестиУчетПоПодразделениям;
	Элементы.ВестиУчетЗатратПоПодразделениямСводно.Доступность 					= НЕ ВестиУчетПоПодразделениям;
	Элементы.Предупреждение.Видимость = ВестиУчетПоПодразделениям;
