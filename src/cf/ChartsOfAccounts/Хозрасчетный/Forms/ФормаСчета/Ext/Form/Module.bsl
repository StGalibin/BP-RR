...
Функция ОграничениеСпискаСубконто(Знач Счет = Неопределено)
	...
	УчетТоваровВРознице = ОбщегоНазначенияКлиентСервер.СократитьМассив(УчетТоваровВРознице, СчетаИсключения);
	...
	УчетЗапасов = ОбщегоНазначенияКлиентСервер.СократитьМассив(УчетЗапасов, СчетаИсключения);
	УчетЗапасов = ОбщегоНазначенияКлиентСервер.СократитьМассив(УчетЗапасов, УчетТоваровВРознице);
	...
	УчетРасчетовСПерсоналом = ОбщегоНазначенияКлиентСервер.СократитьМассив(УчетРасчетовСПерсоналом, СчетаИсключения);
