...
Функция УсловиеВыполняется(Условие, Период, Периодичность, Организация) Экспорт
	...
	Если Условие = ЗначенияПеречисления.ВыставлениеСчетовФактурНеплательщикамиНДС Тогда
	...
	Если Условие = ЗначенияПеречисления.ОтчетностьНалоговогоАгентаПоНДФЛ Тогда
	...
	Если Условие = ЗначенияПеречисления.РегистрацияНовойОрганизации Тогда
