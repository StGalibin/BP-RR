...
Процедура СформироватьДеревоСтраницПоДанным()
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_Страница1_1;ПФ_Форма2014_1_Страница1_2";
...
#Область ЛистыАБВ
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистВ"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаВ1;ПФ_Форма2014_1_СтраницаВ2";
	КонецЦикла;
#КонецОбласти
...
#Область ЛистыГ
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистГ1"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаГ1";
		...
		Для Каждого СтрПодч Из ДанныеМногостраничныхРазделов["ЛистГ2_3"] Цикл 
			...
			Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаГ2;ПФ_Форма2014_1_СтраницаГ3";
		КонецЦикла;
	КонецЦикла;
#КонецОбласти
...
#Область ЛистыДЕЖЗИ
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистЕ"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаЕ1;ПФ_Форма2014_1_СтраницаЕ2";
	КонецЦикла;
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистЖ"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаЖ1;ПФ_Форма2014_1_СтраницаЖ2;ПФ_Форма2014_1_СтраницаЖ3";
	КонецЦикла;
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистЗ"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаЗ1;ПФ_Форма2014_1_СтраницаЗ2";
	КонецЦикла;
...
#Область ЛистыКЛМН
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистН"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаН1;ПФ_Форма2014_1_СтраницаН2;ПФ_Форма2014_1_СтраницаН3";
	КонецЦикла;
#КонецОбласти
КонецПроцедуры
