...
Функция ДеревоФормИФорматов() Экспорт
	...
	ВерсияВыгрузки = РегламентированнаяОтчетность.ПолучитьВерсиюВыгрузкиСтатОтчета("РегламентированныйОтчетСтатистикаФорма1П", "ФормаОтчета2016Кв1");
...
Функция СформироватьСтруктуруПараметров2016(КонтекстФормы, мСохраненныйДок)
	...
	ДопАтрибуты = РегламентированнаяОтчетность.СформироватьСтруктуруДопАтрибутов("Отчет.РегламентированныйОтчетСтатистикаФорма1П.Форма.ФормаОтчета2016Кв1", "АтрибВыгрузкиXML2016Кв1");
...
Функция ТекстВыгрузкиОтчетаСтатистики(мСохраненныйДок, ВыбраннаяФорма) Экспорт 
	...
	Если ВыбраннаяФорма = "ФормаОтчета2016Кв1" Тогда
		...
		ПараметрыВыгрузки = СформироватьСтруктуруПараметров2016(КонтекстФормы, мСохраненныйДок);
