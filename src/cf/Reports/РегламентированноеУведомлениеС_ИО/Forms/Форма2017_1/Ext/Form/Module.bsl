...
Процедура СформироватьДеревоСтраниц()
	...
	Стр001.МакетыПФ = "ПФ_Форма2017_1_Титульная";
	...
	Стр001.МакетыПФ = "ПФ_Форма2017_1_Лист002";
	...
	ИсСтроки01.МакетыПФ = "ПФ_Форма2017_1_ЛистЕ";
	...
	ИсСтроки01.МакетыПФ = "ПФ_Форма2017_1_ЛистЖ";
	...
	ИсСтроки01.МакетыПФ = "ПФ_Форма2017_1_ЛистЗ";
	...
	Стр001.МакетыПФ = "ПФ_Форма2017_1_ЛистА";
	...
	Стр001.МакетыПФ = "ПФ_Форма2017_1_ЛистБ";
	...
	Стр001.МакетыПФ = "ПФ_Форма2017_1_ЛистВ";
	...
	Стр001.МакетыПФ = "ПФ_Форма2017_1_ЛистГ";
	...
	Стр001.МакетыПФ = "ПФ_Форма2017_1_ЛистД";
КонецПроцедуры
...
Функция ЗагрузитьИдентификаторНаСервере(РегОтчет, ОписаниеОшибки)
	...
	Если Не ЗначениеЗаполнено(ИмяФайла) Тогда
		ОписаниеОшибки = "Данный отчет не был сдан в налоговую инспекцию";
		Возврат Ложь;
	КонецЕсли;
