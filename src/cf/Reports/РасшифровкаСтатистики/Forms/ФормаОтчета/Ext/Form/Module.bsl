...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = Форма.ПредставлениеОтчета + " " + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(Отчет.НачалоПериода, Отчет.КонецПериода) + БухгалтерскиеОтчетыВызовСервера.ПолучитьТекстОрганизация(Отчет.Организация);
