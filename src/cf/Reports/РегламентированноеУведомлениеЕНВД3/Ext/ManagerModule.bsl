...
Функция ПроверитьДокументСВыводомВТаблицу_Форма2014_1(Данные, УникальныйИдентификатор)
	...
	ИначеЕсли СтрДлина(СокрЛП(Титульный.П_ОГРН)) <> 13 И СтрДлина(СокрЛП(Титульный.П_ОГРН)) <> 0 Тогда 
	...
	ИначеЕсли СтрДлина(СокрЛП(Титульный.П_ИНН)) <> 10 Тогда 
	...
	ИначеЕсли СтрДлина(СокрЛП(Титульный.П_КПП)) <> 9 Тогда 
