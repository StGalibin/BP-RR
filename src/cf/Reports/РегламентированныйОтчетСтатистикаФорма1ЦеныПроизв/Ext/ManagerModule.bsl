...
Функция ДеревоФормИФорматов() Экспорт
	...
	ВерсияВыгрузки = РегламентированнаяОтчетность.ПолучитьВерсиюВыгрузкиСтатОтчета("РегламентированныйОтчетСтатистикаФорма1ЦеныПроизв", "ФормаОтчета2017Кв1");
	РегламентированнаяОтчетность.ОпределитьФорматВДеревеФормИФорматов(Форма20160101, "26-01-2017");
...
Функция СформироватьСпискиВыбора(ИмяОтчета)
	...
	МакетСоставаПоказателей = Отчеты[ИмяОтчета].ПолучитьМакет("Списки2016Кв1");
...
Функция ТекстВыгрузкиОтчетаСтатистики(мСохраненныйДок, ВыбраннаяФорма) Экспорт 
	...
	Если ВыбраннаяФорма = "ФормаОтчета2016Кв1" Тогда 
		...
		ИмяАтрибутов = ?(РеквизитыДокумента.Периодичность = Перечисления.Периодичность.Месяц, "АтрибВыгрузкиXML2016Кв1_месяц", "АтрибВыгрузкиXML2016Кв1_год");
