...
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	ПараметрыПисьма = ПодготовитьПараметрыЭлектронногоПисьма(Расшифровка, АдресаПолучателей);
...
Функция ПодготовитьПараметрыЭлектронногоПисьма(Расшифровка, Получатель)
	...
	ТемаПисьма = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонТемаПисьма,
		ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ТаблицаСведенийСчетаНаОплату[0].Организация, "НаименованиеСокращенное"));
	...
	ТекстПисьма = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонТекстаПисьма,
		ТаблицаСведенийСчетаНаОплату[0].НомерДокумента,
		Формат(ТаблицаСведенийСчетаНаОплату[0].ДатаДокумента, "ДЛФ=DD"),
		ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ТаблицаСведенийСчетаНаОплату[0].Документ, "СуммаДокумента"),
