...
Процедура СформироватьСпискиВыбора()
	...
	"Выбор кода бюджетной классификации", КоллекцияСписковВыбора["КБК_Раздел1_Стр050"]);
...
Процедура ЗаполнитьСодержательнуюЧасть(УзелРодитель, ПараметрыВыгрузки)
	...
	// Раздел 2.2.
	//
	ЗаполнитьДаннымиУзел(ДеревоДанныхРаздел2.Строки[0].Данные, ПолучитьПодчиненныйЭлемент(РасчНал, "ВозмРасхПер"));
