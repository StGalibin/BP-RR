...
Процедура ВывестиОбластьДиаграмма(СтруктураДиаграммы)
	...
	СтруктураДиаграммы.ТабличныйДокумент.Рисунки[СтруктураДиаграммы.ИмяДиаграммы].Объект.ОбластьПостроения.ФорматШкалыЗначений = "ЧС=2;ЧН=";
...
Функция ПроверкаАктуальностьДанныхУчета(Организация, Период)
	...
	ПараметрыПроверкиАктуальности = Новый Структура;
	ПараметрыПроверкиАктуальности.Вставить("Организация", Организация);
	ПараметрыПроверкиАктуальности.Вставить("Период",      Период);
	ПараметрыПроверкиАктуальности.Вставить("УИДЗамера",   Неопределено);
	ПараметрыПроверкиАктуальности.Вставить("ПроверятьКонстантуАктуальностиДанныхУчета", Ложь);
