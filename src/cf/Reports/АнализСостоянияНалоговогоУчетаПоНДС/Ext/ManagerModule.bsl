...
Функция ПолучитьПараметрыЗапроса(ПараметрыОтчета) Экспорт
	...
	СобытияНеОтражаемыеВРазделеНачисленияПоРеализации = Новый СписокЗначений;
	СобытияНеОтражаемыеВРазделеНачисленияПоРеализации.Добавить(Перечисления.СобытияПоНДСПродажи.ПодтвержденаСтавка0);
	СобытияНеОтражаемыеВРазделеНачисленияПоРеализации.Добавить(Перечисления.СобытияПоНДСПродажи.НеПодтвержденаСтавка0);
	Если СтрЗаменить(ПараметрыОтчета.ВидКарты, "82", "") = "СложныйУчетНДС" Тогда
		СобытияНеОтражаемыеВРазделеНачисленияПоРеализации.Добавить(Перечисления.СобытияПоНДСПродажи.ВосстановлениеНДС);
	КонецЕсли;
	...
	Запрос.УстановитьПараметр("СобытияНеОтражаемыеВРазделеНачисленияПоРеализации", СобытияНеОтражаемыеВРазделеНачисленияПоРеализации);
