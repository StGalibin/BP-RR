...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Иначе
		...
		Если ВидДокумента = Перечисления.ВидыДокументовЕГАИС.ЗапросОстатковВТорговомЗале Тогда
			МассивНепроверяемыхРеквизитов.Добавить("ОстаткиПоДаннымЕГАИС.СправкаБ");
		КонецЕсли;
...
Функция ПолучитьТаблицуДвижений()
	...
	|	ВЫБОР
	|		КОГДА ОстаткиЕГАИСКорректировкаОстатков.Количество > 0
	|			ТОГДА ОстаткиЕГАИСКорректировкаОстатков.Количество
	|		ИНАЧЕ -ОстаткиЕГАИСКорректировкаОстатков.Количество
