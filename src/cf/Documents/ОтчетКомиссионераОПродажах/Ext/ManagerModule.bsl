...
Функция ТекстЗапросаДанныеДляПечатиСчетовФактур(НомераТаблиц) Экспорт
	...
	|	РеквизитыПредварительная.СведенияОТранспортировкеИГрузе,
	|	РеквизитыПредварительная.ОтветственныйЗаОформление,
	|	РеквизитыПредварительная.СопроводительныеДокументы,
	|	РеквизитыПредварительная.Перевозчик,
	|	РеквизитыПредварительная.ПеревозкаАвтотранспортом
	|ИЗ
