...
Процедура НалоговыйПериодПриИзменении(Элемент)
	...
	РасходныйКассовыйОрдерФормыКлиент.НалоговыйПериодПриИзменении(ЭтотОбъект, Элемент);
...
Процедура НапечататьЧекВыполнить()
	...
	РасходныйКассовыйОрдерФормыКлиент.НапечататьЧек(ЭтотОбъект);
...
Процедура ЗаполнитьПоВыбраннойНастройкеПлатежаВБюджет(ВыбранноеЗначение)
	...
	РасходныйКассовыйОрдерФормы.ЗаполнитьПоВыбраннойНастройкеПлатежаВБюджет(ВыбранноеЗначение);
...
Процедура ОткрытьФормуРасшифровкаПлатежа()
	...
	Шапка = Новый Структура("Ссылка, ВалютаДокумента, ВидОперации, Дата, Контрагент, Организация,
		|СчетКасса, СчетКонтрагента, СчетОрганизации, СуммаДокумента, Графа7_УСН");
