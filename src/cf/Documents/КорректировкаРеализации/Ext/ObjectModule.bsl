...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	УчетНДС.СформироватьДвиженияКорректировкиРеализацияТоваровУслуг(
		СтруктураТаблицНДСПоКурсуАванса.ТаблицаТоварыУслуги,
		ПараметрыПроведения.НДСТоварыГТД,
		СтруктураТаблицНДСПоКурсуАванса.ТаблицаНачисление,
		ПараметрыПроведения.НДСВычет,
		СтруктураТаблицНДСПоКурсуАванса.ТаблицаВосстановление,
		ПараметрыПроведения.НДСКнигаПродаж,
		ПараметрыПроведения.НДСКнигаПокупок,
		ПараметрыПроведения.НДСПредъявленный,
