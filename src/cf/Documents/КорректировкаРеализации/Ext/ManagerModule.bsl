...
Функция ПодготовитьСтруктуруВыручкиПоВидамДеятельности(ТаблицаСобственныеТоварыУслуги, ТаблицаТоварыУслугиКомитентов, ТаблицаРеквизиты) Экспорт
	...
	СтруктураВыручки = Новый Структура("Всего, НДС, ЕНВД, Комиссия, ТорговыйСбор, Патент",
		ВыручкаВсего, ВыручкаНДС, ВыручкаЕНВД, ВыручкаКомиссии, ВыручкаТорговыйСбор, ВыручкаПатент);
	...
	СтруктураВыручки.НДС          = ВыручкаНДС;
	СтруктураВыручки.ЕНВД         = ВыручкаЕНВД;
	СтруктураВыручки.Комиссия     = ВыручкаКомиссии;
	СтруктураВыручки.ТорговыйСбор = ВыручкаТорговыйСбор;
...
Функция ПодготовитьТаблицуВозвращенныеТоварыУСН(ТаблицаТоварыВозврат, ТаблицаРеквизиты) Экспорт
	...
	Если Не Параметры.Реквизиты[0].ПрименяетсяУСНДоходыМинусРасходы Тогда
		Возврат Неопределено;
	КонецЕсли;
