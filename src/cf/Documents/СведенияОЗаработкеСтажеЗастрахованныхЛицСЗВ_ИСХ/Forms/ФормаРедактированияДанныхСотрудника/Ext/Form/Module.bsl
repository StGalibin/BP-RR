...
Процедура УстановитьСвойстваЭлементовФормы()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СведенияОЗаработкеЗаработок", "ТолькоПросмотр", ОтчетныйГод >= 2002 И ОтчетныйГод <= 2009);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СведенияОЗаработкеОблагаетсяВзносамиДоПредельнойВеличины", "ТолькоПросмотр", ОтчетныйГод >= 2002 И ОтчетныйГод <= 2009);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СведенияОЗаработкеПоДоговорамГПХДоПредельнойВеличины", "ТолькоПросмотр", ОтчетныйГод <= 2009);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СведенияОЗаработкеОблагаетсяВзносамиСвышеПредельнойВеличины", "ТолькоПросмотр", ОтчетныйГод <= 2009);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СведенияОЗаработкеПоДоговорамГПХСвышеПредельнойВеличины", "ТолькоПросмотр", ОтчетныйГод <= 2009);
