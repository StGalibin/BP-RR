...
// устанавливает для пользовательских макетов счета-фактуры без идентификатора госконтракта Использование = Ложь
Процедура СброситьИспользованиеПользовательскогоМакетаСчетаФактуры() Экспорт
