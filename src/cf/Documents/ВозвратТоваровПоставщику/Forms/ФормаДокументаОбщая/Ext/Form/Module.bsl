...
Процедура УстановитьЭлементыПоВидуОперации(Форма)
	...
	Элементы.ФормаВыгрузитьВГИСМ.Видимость = Объект.ВидОперации = Перечисления.ВидыОперацийВозвратТоваровПоставщику.ПокупкаКомиссия;
	Элементы.ФормаВыгрузитьВЕГАИС.Видимость = Объект.ВидОперации = Перечисления.ВидыОперацийВозвратТоваровПоставщику.ПокупкаКомиссия;
...
Процедура ВыгрузитьВЕГАИС(Команда)
	...
	ОткрытьФорму("Документ.ТТНИсходящаяЕГАИС.ФормаОбъекта", ДополнительныеПараметры);
