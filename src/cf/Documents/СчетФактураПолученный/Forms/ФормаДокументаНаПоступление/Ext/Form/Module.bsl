...
Процедура ПодготовитьФормуНаСервере()
	...
	Если ЗначениеЗаполнено(Объект.ДоговорКонтрагента) Тогда
		СвойстваДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Объект.ДоговорКонтрагента, "ВидДоговора,НДСПоСтавкам4и2");
...
Процедура УправлениеФормой(Форма)
	...
	Если Объект.Дата >= '20150101' Тогда
		...
		ИначеЕсли КоличествоСчетовФактурВыданныхПокупателям > 1 Тогда
			...
			Форма.НадписьСчетаФактурыВыданныеПокупателю = УчетНДСКлиентСервер.ПредставлениеСсылкиПредмета(
		...
		ИначеЕсли КоличествоПродавцов > 1 Тогда
			...
			Форма.НадписьНесколькоПродавцовСсылка = УчетНДСКлиентСервер.ПредставлениеСсылкиПредмета(
