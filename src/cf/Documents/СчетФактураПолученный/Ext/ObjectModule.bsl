...
Процедура ЗаполнитьСчетФактуруНаАванс(Основание, СчетФактура = Неопределено) Экспорт
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, ПараметрыЗаполнения.Реквизиты, , "ДоговорКонтрагента");
	// Для счета-фактуры полученного на выданный аванс комиссионеру по закупке дополнительно заполняем договор,
	// который необходим для заполнения дополнительных реквизитов счета-фактуры.
	РеквизитыДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(
		ПараметрыЗаполнения.Реквизиты.ДоговорКонтрагента, "ВидДоговора, ВалютаВзаиморасчетов");
	Если РеквизитыДоговора.ВидДоговора = Перечисления.ВидыДоговоровКонтрагентов.СКомиссионеромНаЗакупку Тогда 
		ДоговорКонтрагента = ПараметрыЗаполнения.Реквизиты.ДоговорКонтрагента;
	КонецЕсли;
	...
	Если ТипЗнч(Основание) = Тип("ДокументСсылка.ПоступлениеТоваровУслуг") Тогда
		...
		Иначе
			...
			Если ЗначениеЗаполнено(Основание.ДоговорКонтрагента) Тогда 
				РеквизитыДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Основание.ДоговорКонтрагента, "УчетАгентскогоНДС,ВидДоговора");
...
Функция ПолучитьКодВидаОперации(КодВидаОперацииОснования = Неопределено)
	...
	Если ЗначениеЗаполнено(ДоговорКонтрагента) Тогда
		СвойстваДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДоговорКонтрагента, "ВидДоговора,НДСПоСтавкам4и2");
		СтруктураПараметров.Вставить("ВидДоговора", СвойстваДоговора.ВидДоговора);
