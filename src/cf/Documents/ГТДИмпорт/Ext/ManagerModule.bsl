...
Функция ТекстЗапросаРеквизитыДокумента()
	...
	|	ГТДИмпорт.СпособЗачетаАвансов,
	|	ГТДИмпорт.НДСВключенВСтоимость,
	|	РеквизитыДоговоров.Валютный,
	|	РеквизитыДоговоров.ВидДоговора,
	|	РеквизитыДоговоров.УчетАгентскогоНДС
...
Функция ТекстЗапросаНДС(НомераТаблиц)
	...
	|	Реквизиты.Период КАК ДатаСчетаФактуры,
	...
	|	КОНЕЦ КАК Продавец,
	|	(ВЫРАЗИТЬ(РазделыДокумента.ТаможеннаяСтоимость * &КоэффициентТаможеннаяСтоимостьРуб КАК ЧИСЛО(15, 2))) + РазделыДокумента.СуммаПошлины + РазделыДокумента.СуммаНДС КАК СуммаПоСчетуФактуре,
	|	РазделыДокумента.СуммаНДС КАК СуммаНДС,
	...
	|	СУММА(ВТРегистрацияВЖурнале.СуммаПоСчетуФактуре) КАК СуммаПоСчетуФактуре,
