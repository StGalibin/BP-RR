...
Процедура ВидЭДПриИзменении(Элемент)
	...
	СохранитьВидЭДПоУмолчанию(Объект.ВидОперации, Объект.ВидЭлектронногоДокумента);
...
Процедура ПодготовитьФормуНаСервере() Экспорт
	...
	РеализацияТоваровУслугФормы.ЗаполнитьСписокВыбораОтражениеДоходов(ЭтаФорма);
	РеализацияТоваровУслугФормы.УстановитьОтражениеДоходов(ЭтаФорма);
	...
	РеализацияТоваровУслугФормы.УстановитьВидЭД(ЭтотОбъект);
...
Процедура СохранитьВидЭДПоУмолчанию(ВидОперации, ВидЭД)
	
	РеализацияТоваровУслугФормы.СохранитьВидЭДПоУмолчанию(ВидОперации, ВидЭД);
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ОтражениеДоходов.Видимость = Форма.ПрименяетсяТолькоУСНПатент Или Форма.ПрименяетсяУСНПатент Или Форма.РаздельныйУчетТорговыйСборПриУСН;
...
Процедура ОтражениеДоходовПриИзмененииНаСервере()
	...
	РеализацияТоваровУслугФормы.ОтражениеДоходовПриИзменении(ЭтаФорма);
...
Процедура ОбработкаВыбораПодборВставкаИзБуфераНаСервере(ВыбранноеЗначение, ИмяТаблицы)
	...
	ЗаполнитьПризнакМаркируемойПродукцииТаблицыТовары(ДобавленныеСтроки.Товары, ВестиУчетМаркировкиПродукцииВГИСМ);
