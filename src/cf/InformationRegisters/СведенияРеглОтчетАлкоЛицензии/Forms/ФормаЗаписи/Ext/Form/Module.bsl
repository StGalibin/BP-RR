...
Процедура ВводАдресаНаКлиенте()
	...
	// По умолчанию будет использовано Справочники.ВидыКонтактнойИнформации.ФактАдресОрганизации.
	...
	РегламентированнаяОтчетностьАЛКОКлиент.ВызватьФормуВводаАдресаАЛКО(
							АдресМестаДеятельности, Заголовок, Оповещение, ВидКонтактнойИнформации);
