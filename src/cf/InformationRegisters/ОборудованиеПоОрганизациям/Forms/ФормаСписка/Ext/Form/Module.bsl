...
Процедура МобильнаяКасса(Команда)
	...
	НовыйЭкземплярОборудования(ПредопределенноеЗначение("Перечисление.ТипыПодключаемогоОборудования.WebСервисОборудование"));
...
Процедура ККМOffline(Команда)
	...
	НовыйЭкземплярОборудования(ПредопределенноеЗначение("Перечисление.ТипыПодключаемогоОборудования.ККМOffline"));
