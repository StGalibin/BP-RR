...
Процедура УстановитьМестаВыплатыЗарплатыСотрудников() Экспорт
	...
	|		ПО ЛицевыеСчетаСотрудниковПоЗарплатнымПроектамСрезПоследних.Организация = ТекущиеКадровыеДанныеСотрудников.ТекущаяОрганизация
	|			И ЛицевыеСчетаСотрудниковПоЗарплатнымПроектамСрезПоследних.ФизическоеЛицо = ТекущиеКадровыеДанныеСотрудников.ФизическоеЛицо
	|ГДЕ
	|	НЕ ЛицевыеСчетаСотрудниковПоЗарплатнымПроектамСрезПоследних.ФизическоеЛицо В
	|				(ВЫБРАТЬ
	|					ВТ_Исключения.ФизическоеЛицо
	|				ИЗ
	|					ВТ_Исключения)
	|	И НЕ ЛицевыеСчетаСотрудниковПоЗарплатнымПроектамСрезПоследних.Организация В
	|				(ВЫБРАТЬ
	...
	|ВЫБРАТЬ
	|	ВТ_ВыплатаЗарплатныйПроект.Сотрудник,
	|	ВТ_ВыплатаЗарплатныйПроект.ФизическоеЛицо,
	|	ВТ_ВыплатаЗарплатныйПроект.Вид
