...
Процедура ОбновитьИсторию(СтруктурнаяЕдиница, РегистрацияВНалоговомОргане) Экспорт
	
	СтруктураРегистра = УчетЗарплаты.НовыйСтруктураРегистраДляОбновленияИстории();
	СтруктураРегистра.ИмяРегистра            = "ИсторияРегистрацийВНалоговомОргане";
	СтруктураРегистра.ПериодАктуальнойЗаписи = ДатаОтсчетаПериодическихСведений();
	СтруктураРегистра.ИмяИзмерения           = "СтруктурнаяЕдиница";
	СтруктураРегистра.ИмяРесурса             = "РегистрацияВНалоговомОргане";
	СтруктураРегистра.ПропускатьПроверкуПриОтсутствииЗаписей = Истина;
	
	УчетЗарплаты.ОбновитьИсторию(СтруктураРегистра, СтруктурнаяЕдиница, РегистрацияВНалоговомОргане);
