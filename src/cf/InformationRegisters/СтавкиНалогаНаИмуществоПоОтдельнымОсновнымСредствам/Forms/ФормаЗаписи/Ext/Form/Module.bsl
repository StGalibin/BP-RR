...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ГруппаНалоговаяСтавка.Видимость = ПостановкаНаУчетВДругомНалоговомОргане ИЛИ ОпределениеНалоговойБазыПоКадастровойСтоимости;
	...
	Элементы.ГруппаСниженнаяНалоговаяСтавка.Видимость             = ОблагаетсяПоСниженнойСтавке;
	...
	Элементы.КодВидаИмущества.Подсказка = Форма.КодыВидовИмущества.Получить(Объект.КодВидаИмущества);
